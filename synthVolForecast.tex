...
We show the applicability of Synthetic Volatility Forecasting using an real data example that sits at the crossroads of market trading and electoral politics.  In the spring of 2016 in the USA, the Republican Party's primary election process narrowed down candidates until Donald J. Trump cleared the threshold of votes to win the nomination formally at the party's convention that summer.  He would go on to face the Democratic Party's nominee, Hillary Rodham Clinton.  As is well-known, the Electoral College has the capability of making presidential races more competitive than a raw vote total might, generating a corresponding increase in uncertainty about the country's future leadership.  From an ex-ante perspective, several key qualities of this particular US election cycle as well as the candidates themselves might also be considered volatility-inducing.  The election featured no incumbent, ruling out any incumbent-advantage.  The Republican Party candidate took up unorthodox positions on matters such as healthcare and trade policy, positions that could be considered rare in either of the major two parties.  Additionally, Donald J. Trump, lacking any record in government service -- either electoral or appointed service -- gave his opponent no voting record to attack.  More broadly, Trump presented both the electorate and political prognosticators with a complete novelty.  For these reasons, the aftermath of the 2016 presidential election meets the standard of an interesting and notable event for which a quantitative researcher might seek a point prediction.  On a more technical level, the result of the election arrived in the evening of election day, following the closing of financial markets at 4pm Eastern Time.  This meets the standard of a shock that has not yet been digested by liquid markets.  We therefore proceed to make the following technical specifications in order to predict the volatility of financial services ETF IYG\footnote{It has been noted that GARCH effects are more attenuated in aggregated returns \citep{zivot2009practical}, which suggests against using the S\&P 500 or similar indices as an example.} (an ETF composed of American financial majors JPMorgan, Bank of American, etcetera) on Wednesday November 9th, 2016.
...
\begin{enumerate}
    ...
    \item \textbf{Choice of estimator for volatility}We use the sum of squared 5-minute log-returns of IYG on November 9th, 2016, otherwise known as the Realized Volatility estimator of volatility, as our proxy.  We exclude the first five minutes of the trading day, resulting in 79 sums generated between 9:35am and 4pm.
\end{enumerate} 
