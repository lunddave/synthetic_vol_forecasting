...
Given the preceding review, pause to take stock of several key components of forecast adjustments.

\begin{itemize}
  \item Automated or non-automated
  \item The parametric term to be corrected (e.g. intercept, coefficients), if any
  \item The correction function 
...
\citet{guerron2017macroeconomic}, citing previous work, discuss that intercept corrections find their theoretical basis in structural breaks, whereas Nearest-Neighbor methods, being nonparametric, are theoretically more adept at accounting for nonlinearity.
