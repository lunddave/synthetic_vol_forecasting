...
\begin{align}
  & QL(\hat\sigma_{t+1}^{2}_{unadjusted},\sigma^{2})-QL(\hat\sigma^{2}_{adjusted},\sigma^{2})\\
   & =(\frac{\hat\sigma^{2}_{unadjusted}}{\sigma^{2}} - \log{\frac{\hat\sigma^{2}_{adjusted}}{\sigma^{2}}} - 1) - (\frac{\hat\sigma^{2}_{unadjusted}}{\sigma^{2}} - \log{\frac{\hat\sigma^{2}_{adjusted}}{\sigma^{2}}} - 1)\\
   & = \frac{\hat\sigma^{2}_{unadjusted}-\hat\sigma^{2}_{adjusted}}{\sigma^{2}} - \log{\frac{\hat\sigma^{2}_{adjusted}}{\hat\sigma^{2}_{unadjusted}}}\label{QL Loss Consistency}
\end{align}
...
\subsection{Unique of Convex Combinations}
