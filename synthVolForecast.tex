  ...
  \begin{figure}[H]
    ...
    \begin{figure}[H]
      \begin{center}
        ...
        \includegraphics[scale=.6]{real_data_output_plots/FriAug300111162024_IYG_None_None.png}
        \caption{When Brexit is taken to begin June 23rd, 2016, and last through June 24th, 2016, its own weight is still unchanged.  The fixed effect estimate of the shock is large, but not as large when the shock is taken to be June 23rd, 2016.}
