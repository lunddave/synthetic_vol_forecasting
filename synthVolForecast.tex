...
\subsection{Excess Volatility Estimators}
    ...
    \begin{align*}
    \{\pi\}_{i=2}^{n+1} = \argmin_{\pi}\|\textbf{v}_{1} - \V_{p,n}\pi \|_{\textbf{S}}
    \end{align*}
...
In order to investigate the Synthetic Volatility Forecasting method, our most elementary simulation uses $\mc{M}_1$.  We vary only two parameters. 
