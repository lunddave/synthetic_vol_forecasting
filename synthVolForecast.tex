...
\begin{lem}
  Under assumption \ref{stationarity_of_omega_i_t} above, $\forall i, \{\omega_{i,t}^{*}\}_{t=0,...,T_i}$ is a strictly stationary series.
\end{lem}
...
\begin{prop}
  Here we use the result above to show that $\hat\sigma^{2}_{1,T^{*}+r}\xrightarrow{p}\sigma^{2}_{1,T^{*}+r}, r = 1,...,k$.
\end{prop}
