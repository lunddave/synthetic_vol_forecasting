...
The aggregated shock-effect estimator $\hat\omega^{*}_{i,t}$ in \eqref{adjustment} is central to our forecast adjustment strategy.  Here we show that the quantities $\hat\omega^{*}_{i,t}$ possess an important asymptotic property that bolsters that overall reliability of the method proposed herein.
