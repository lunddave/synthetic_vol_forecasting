...
\begin{enumerate}[\itshape]
  ...
  \item $\forall i, \{D^{vol}_{i,t}\}_{t=1,...,T_i}$, supported on $\{0,1\}^{T_i}$ is exactly 1 at the shock times $\{T^{*}_{i}+1,...,T^{*}_{i}+k\}$ and exactly zero otherwise.
  \item Let conditions Assumption 1 of \citet{han2014asymptotic} prevail.
\end{enumerate}

Then $\hat\omega_{i}^{*} \xrightarrow{p} \E[\omega_{i}^{*}]$
