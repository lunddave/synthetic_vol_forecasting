...
\boldsymbol\theta_{t} & \sim \boldsymbol\alpha & \textbf{the ARCH parameters} \\
\textbf{Z}_{i} & \sim \boldsymbol a_{t-k} & \textbf{observable quantities} \\
\boldsymbol \lambda_{t} & \sim \boldsymbol\beta & \textbf{the GARCH parameters} \\
\boldsymbol \mu_{i} & \sim \boldsymbol \sigma_{i,t-k}^{2} & \textbf{latent quantities}   \\
\end{align*}
