...
\item  if donors are indep, a non sparse linear combination could have lowest risk
\item if donors are highly correlated, the s-sparse eg convex hull implies s choose 2 covariances
\end{enumerate}
...
\begin{enumerate}
\item Each varying parameter inputted to the simulations
\item Each parameter generated randomly the simulations
\item Each pair of linear combination AND loss function (12 * 3 = 36).  I'll end up needing approximately that many ANOVAs.
