...
We show the applicability of Synthetic Volatility Forecasting using an real data example that sits at the crossroads of financial trading and electoral politics.  In the spring of 2016 in the USA, the Republican Party's primary election process narrowed down candidates until Donald J. Trump cleared the threshold of votes to win the nomination formally at the party's convention that summer.  He would go on to face the Democratic Party's nominee, Hillary Rodham Clinton.  The Electoral College permits victory without a majority or even plurality of the popular vote, which has the tendency of making the presidential races more competitive than a raw vote total would, generating a corresponding increase in uncertainty about the country's future leadership.  From an ex-ante perspective, several qualities of this particular US election cycle as well as the candidates themselves might also be considered difficult to prognosticate.  The election featured no incumbent, ruling out any incumbent-advantage.  The Republican Party candidate took up unorthodox, populist positions on matters such as healthcare and trade policy, positions that could be considered rare in either of the major two parties.  Additionally, Donald J. Trump, lacking any record in government service -- either electoral or appointed service -- possessed no voting record for voters to judge or or his opponents to attack.  Acclaimed forecasting outlet 538, headed by economist Nate Silver, predicted a Clinton victory with a probability of .714, more than 2-to-1 odds \citep{Silver_2016}, suggesting that the result was at least somewhat surprising.  For these reasons, the aftermath of the 2016 presidential election meets the standard of an interesting and notable event for which a quantitative researcher might seek a point prediction.  On a more technical level, the result of the election arrived in the evening of election day, following the closing of financial markets at 4pm Eastern Time.  This meets the standard of a shock that has not yet been digested by liquid markets.  We therefore proceed to make the following technical specifications in order to predict the volatility of financial services ETF IYG\footnote{It has been noted that GARCH effects are more attenuated in aggregated returns \citep{zivot2009practical}, which suggests against using the S\&P 500 or similar indices as an example.} (an ETF composed of American financial majors JPMorgan, Bank of American, etcetera) on Wednesday November 9th, 2016.
...
\begin{enumerate}
    ...
    \item \textbf{Donor pool construction} Synthetic Control, an a tool of causal inference, often goes about weighting control units by identifying a natural set of donors such as the untreated units within a set of subnational units like US states \citep{abadie2010synthetic} or Spanish provinces \citep{abadie2003economic}.  While such an endeavor is not necessarily preclude considered judgments (should Canadian provinces be used as donors for a treated US state?), as a tool of small-n prediction, distanced-based weighting faces a decidedly more difficult task in constructing a donor pool.  For our purposes, we choose the three US presidential elections prior to the 2016 election as well as the Brexit vote held in the UK in May 2016.  Note that the constituent companies in the IYG, all of which had operations in London, were greatly exposed to the UK's decision to remain or exit the EU.  We exclude the midterm races in the US, which generate far lower voter turnout and feature no national race.  
