...
Implied_Volatility_{T^{*},1} & Volatility_{T^{*},2} & \cdots & RV_{T^{*},D}
Implied_Volatility_{T^{*}-1,1}  & Volatility_{T^{*}-1,2}  & \cdots & RV_{T^{*}-1,D} 
