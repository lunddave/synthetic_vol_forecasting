...
\subsection{Excess Volatility Estimators}
    ...
    Following \citet{abadie2003economic,abadie2010synthetic}, let $\|\cdot\|_{\textbf{V}}$ denote any semi-norm, and define

    \begin{align*}
    \{\pi\}_{i=2}^{n+1} = \argmin_{\pi}\|\textbf{v}_{1} - \V_{p,n}\pi \|_{\textbf{V}}
    \end{align*}
