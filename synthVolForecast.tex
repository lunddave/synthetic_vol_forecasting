...
The estimators $\hat\omega^{*}_{i,T_{i}^{*}+1}$ in \eqref{adjustment} are central to our forecast adjustment strategy.  Here we show that the quantities $\hat\omega^{*}_{i,T_{i}^{*}+1}$ possess an important asymptotic property that bolsters that overall reliability of the method proposed herein.
...
Having established the consistency of the estimators $\hat\omega^{*}_{i,T_{i}^{*}+1}$, we extend that result to prove the consistency of the conditional forecast function itself.
  ...
  \begin{prop}\label{sigma_consistency}
    ...
    \begin{enumerate}
     ...
     \end{enumerate}
  Then for any $r$, $1\leq r \leq k$, $\hat\sigma^{2}_{adjusted,T_{i}^{*}+r}\overset{p}{\longrightarrow}\sigma^{2}_{1,T_{i}^{*}+r}$ as $t\rightarrow\infty$. 
  \end{prop}
...
\begin{enumerate}
    ...
    \item \textbf{Covariate Choice} We choose covariates that could plausibly satisfy the model assumptions spelled out earlier, that is, risk-related and macroeconomic covariates that could plausibly be weighted and summed in a shock distribution.  We thus choose the log return Crude Oil (CL.F), the VIX (VIX) and the log return of the VIX, the log returns of the three-month, five-year, ten-year, and thirty-year US Treasuries, as well as the log return of the most recently available monthly spread between AAA and BAA corporate debt, widely considered a proxy for lending risk \citep{goodell2013us, kane1996p}.  Finally, we include the squares of the demeaned log return of IYG for the thirty trading days preceding the shocks.  For each variable in the volatility profile, we compute the sample mean and sample standard deviation across the $n+1$ events, allowing us to scale the variables to have zero mean and unit variance.  Hence, no single variable can dominate the distance-based weighting procedure.

    \item \textbf{Donor pool construction} We choose the three most recent US presidential elections prior to the 2016 election as well as several Brexit-related events in the first half of 2016.  The inclusion of the three US presidential elections is straightforward and easily justified.  Those three elections are the only presidential elections since the advent of the ETF IYG, and it is not unreasonable that three elections held in the span of 12 years would share a conditional shock distribution.  We exclude the midterm congressional elections in the US (i.e. those held in even years not divisible by four), which generate far lower voter turnout and feature no national races.  The inclusion of Brexit is less straightforward but perhaps more interesting. We first explain the three donors and then justify their inclusion.  The first Brexit is former UK Prime Minister David Cameron's announcement, on February 19th, 2016, that a referendum would occur to decide the UK's future in the EU.  The second is a poll released on June 14th, 2016 reflecting higher support for Brexit than had been thought.  Last is Brexit itself.  Even though it occurred outside of the United States, the Leave campaign possessed a very similar right-wing populism to that of the Trump campaign \citep{wilson2017brexit}. Furthermore, Brexit preceded the 2016 US presidential election by less than five months and was, according to several news outlets, seen as a harbinger of Trump's victory \citep{kay2016brexit, collins2016trump}. This view was made clear by %Pulitzer Prize winning journalist and historian 
...
\begin{figure}[H]
  ...
  \begin{table}[ht]
    ...
    \begin{tabular}{rll}
      \hline
    QLLoss.AdjustedForecast. & dropped\_covariate & dropped\_donor \\ 
      \hline
    0.0000 & Log Return of IRX & 2004-11-02 \\ 
      0.0017 & Log Return of CL.F & 2004-11-02 \\ 
      0.0049 & Raw.VIX & None \\ 
      0.0056 & Log Return of TNX & 2004-11-02 \\ 
      0.0058 & Raw.VIX & 2004-11-02 \\ 
      0.0064 & None & 2004-11-02 \\ 
      0.0074 & Debt Risk Spread & 2004-11-02 \\ 
      0.0092 & Raw.VIX & 2016-06-23 \\ 
      0.0093 & Log Return of VIX & 2004-11-02 \\ 
      0.0123 & None & 2016-02-19 \\ 
      0.0125 & Raw.VIX & 2016-02-19 \\ 
      0.0128 & Log Return of IRX & 2016-06-23 \\ 
      0.0130 & Log Return of TNX & 2016-06-23 \\ 
      0.0131 & Log Return of TNX & 2016-02-19 \\ 
      0.0136 & Debt Risk Spread & 2016-02-19 \\ 
      0.0140 & Log Return of CL.F & 2016-06-23 \\ 
      0.0142 & Log Return of CL.F & 2016-02-19 \\ 
      0.0143 & Log Return of VIX & 2016-02-19 \\ 
      0.0160 & None & 2016-06-23 \\ 
      0.0190 & Log Return of IRX & 2016-02-19 \\ 
      0.0202 & Log Return of VIX & 2016-06-23 \\ 
      0.0225 & Debt Risk Spread & None \\ 
      0.0231 & Debt Risk Spread & 2016-06-23 \\ 
      0.0279 & Log Return of FVX & 2016-02-19 \\ 
      0.0286 & Log Return of VIX & 2012-11-06 \\ 
      0.0300 & Log Return of TYX & 2016-02-19 \\ 
      0.0346 & IYG & 2004-11-02 \\ 
      0.0358 & Log Return of VIX & 2016-06-13 \\ 
      0.0363 & Log Return of TYX & 2016-06-23 \\ 
      0.0363 & Log Return of FVX & 2016-06-23 \\ 
      0.0397 & Debt Risk Spread & 2008-11-04 \\ 
      0.0437 & Log Return of TYX & 2004-11-02 \\ 
      0.0502 & Log Return of FVX & 2004-11-02 \\ 
      0.0544 & Log Return of CL.F & None \\ 
      0.0559 & Log Return of FVX & None \\ 
      0.0596 & IYG & None \\ 
      0.0598 & Log Return of IRX & None \\ 
      0.0598 & Log Return of VIX & None \\ 
      0.0599 & None & None \\ 
      0.0621 & IYG & 2012-11-06 \\ 
      0.0644 & Log Return of TYX & None \\ 
      0.0710 & Log Return of IRX & 2016-06-13 \\ 
      0.0726 & Log Return of TNX & None \\ 
      0.0735 & Raw.VIX & 2016-06-13 \\ 
      0.0776 & Log Return of IRX & 2012-11-06 \\ 
      0.0836 & Log Return of TNX & 2012-11-06 \\ 
      0.0858 & None & 2012-11-06 \\ 
      0.0903 & Raw.VIX & 2012-11-06 \\ 
      0.0947 & Log Return of CL.F & 2012-11-06 \\ 
      0.1001 & Log Return of TNX & 2016-06-13 \\ 
      0.1013 & IYG & 2016-06-23 \\ 
      0.1038 & Debt Risk Spread & 2012-11-06 \\ 
      0.1051 & None & 2016-06-13 \\ 
      0.1081 & Log Return of IRX & 2008-11-04 \\ 
      0.1145 & Log Return of CL.F & 2016-06-13 \\ 
      0.1174 & Log Return of TYX & 2012-11-06 \\ 
      0.1262 & Log Return of FVX & 2016-06-13 \\ 
      0.1346 & Log Return of FVX & 2012-11-06 \\ 
      0.1511 & Log Return of TYX & 2016-06-13 \\ 
      0.1536 & Debt Risk Spread & 2016-06-13 \\ 
      0.2634 & Log Return of TNX & 2008-11-04 \\ 
      0.2814 & None & 2008-11-04 \\ 
      0.2892 & Log Return of CL.F & 2008-11-04 \\ 
      0.3040 & Log Return of VIX & 2008-11-04 \\ 
      0.3479 & Raw.VIX & 2008-11-04 \\ 
      0.3492 & Log Return of FVX & 2008-11-04 \\ 
      0.3553 & Log Return of TYX & 2008-11-04 \\ 
      0.4096 & IYG & 2016-02-19 \\ 
      0.4920 & IYG & 2008-11-04 \\ 
      0.8302 & IYG & 2016-06-13 \\ 
       \hline
    \end{tabular}
    \endgroup
    \end{table}
