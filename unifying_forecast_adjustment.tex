...
\begin{proof-of-proposition}[\ref{ARIMA_param_consistency}]
  ...
  \begin{proof-of-proposition}[\ref{ARIMA_conv_distribution}]
    ...
    ($\hat\rho_{1},...,\hat\rho_{p}, \hat\alpha_{i,T^{*}+1}$) is consistent at $t\rightarrow \infty$.  Next consider the prediction function for an AR($p$)-X,
