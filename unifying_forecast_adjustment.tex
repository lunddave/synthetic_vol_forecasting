...
In the autumn of 2008, as Great Financial Crisis (GFC) gathered steam, the US Federal Reserve reduced its overnight lending rate to banks to between 0 and 25 basis \citep{GFC}.  Though the US economy (and the globe as a whole) returned to growth by 2009, the US Fed kept interests rates there for more than half a decade.  Only in 2015 did rates begin their gradual and well-telegraphed ascent.  Between 2015 and 2018, the Fed would raise rates at nine meetings, culminating in the December 2018 hike.  In this real data example, we use the eight hikes preceeding the last as donors in order to predict the volatility induced December 2018 rate hike.
...
\begin{enumerate}
  ...
  levels - VIX
  volume - SPY
  a credit related variable available monthly BAA AAA

  \item \textbf{Donor pool construction} We choose the rates hikes 
  ...
  \item \textbf{Data Sources} All daily market data is provided via the YahooFinance API available in the quantmod package in R \citep{ryan2015package} and the R package highfrequency \cite{highfrequency}.  The realized volatility estimates of SPY is provided exclusively by the highfrequency R package. 
\end{enumerate} 
...
\textbf{What is the Model Confidence Set (MCS)?}
