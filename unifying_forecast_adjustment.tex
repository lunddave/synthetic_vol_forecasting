...
Assume
  \begin{enumerate}
    \item For each $i$, $1\leq i \leq n + 1$, let $\{y_{t}\}^{T_{i}}_{i=1}$ follow an AR-X($p$) as laid out in \eqref{AR-X(p)}.
...
Assume
  \begin{enumerate}
   ...
   Then the aggregated estimator $\hat{\alpha_{T^{*}_{1}}}$ is consistent as $t \rightarrow \infty$. 
