...
%Let's throw some images at them
\begin{frame}
...
\uncover<2-2>{Interpolation is a bit harder to visualize for linear regression...}\\
...
%\begin{figure}[h!]
%  \includegraphics[width=0.5\textwidth]{imc.png}
...
\uncover<1-1>{which we want to minimize, of course.}\\
