...
\begin{figure}[H]
    \begin{center}
      \includegraphics[scale=.4]{simulation_plots/alternative_USE_in_paper_simulation_plot_arithmetic_mean.png}
...
Nota bene: the weights $\{\weight_{i}\}_{i=2}^{n+1}$ are deterministic with respect to $\mathcal{F_{T^{*}}}$.
