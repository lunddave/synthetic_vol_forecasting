...
\begin{frame}
    ...
    \begin{enumerate}
        ...
        Unscheduled
        scheduled
        A new seller joins amazon’s platform, i.e. cold starts \citep{fatemi2023mitigating}
        \item What does this contribute to the literature and econometrics more broadly?
        \item  How would you improve your work?  
        \item The most common question you may be asked is what you learned from the
...
\item The next question to follow by default is why you chose this particular topic or
...
\item  What is the importance of your study or how will it contribute or add up to the
existing body of knowledge?
    ...
    \begin{frame}
        \frametitle{Twenty questions}
        \begin{enumerate}
            \item You may be asked to summarize your key findings of the research.
            \item What type of background research have you done for the study?
            \item What are the limitations you have faced while writing?
            \textcolor{red}{A ton of hyperparameters}
            \item Why did you choose this particular method or sample for the study?
            \item What will you include if you are told to add something extra to the study?
            \item What are the recommendations of your study?
            \item 10. Who formed your sample and why you selected this particular age group?
            \item 11. What was your hypothesis and how did you framed it? \textcolor{red}{Signal to noise}
        \end{enumerate}
        \end{frame}
...
\begin{frame}
    ...
    \begin{enumerate}
        ...
        \item 17. What are the research variables you used?
        \item 18. Do you have any questions to be asked?
        \item 19. Did you evaluate your work?
...
\begin{frame}
    ...
    \begin{itemize}
        \item Extending forecast adjustment to the state-of-the-art HAR model 
        \item Extending forecast adjustment to non-linear shock models
...
For example, one loss possible function of interest in this study is the 1-step-ahead MSE using our distance-based-weighting method and \textcolor{red}{Realized Volatility}:
...
\begin{itemize}
    ...
    \item Can we extend the results of \citep{bodilsen2023exploiting}
\end{itemize}
\end{frame}
