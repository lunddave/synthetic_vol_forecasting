...
\begin{frame}
    \frametitle{A High-level Summary Uniting All My Projects}
        ...
        Forecasting under non-ideal conditions like \textcolor{blue}{a rupture in the DGP or a lack of past information for units we wish to forecast}: what should we do?
    ...
    \begin{frame}
        ...
        predicting based on a limited feature space and/or small $n$
...
\begin{frame}
\frametitle{Two Visuals That Tell The Story}
...
\begin{frame}\frametitle{Two Visuals That Tell The Story}
