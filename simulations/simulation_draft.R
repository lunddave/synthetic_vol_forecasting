...
M21_M22_level_mu_delta <- seq(0,.2,.02)
M21_M22_level_sd_delta <- seq(0,.8,.05)
mu_omega_star <- c(.05)
vol_shock_sd <- 1
M21_M22_vol_mu_delta <- c(.2) #seq(0, .5, .05)
M21_M22_vol_sd_delta <- c(.1)
