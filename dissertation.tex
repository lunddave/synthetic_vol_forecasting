...
For a method with such high ambitions --- addressing canonical problems in forecasting --- there will no doubt be subtleties that cannot be addressed fully in this paper.  However, we would like to take time to discuss those nuances.
