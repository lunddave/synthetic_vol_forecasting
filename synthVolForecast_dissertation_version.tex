...
\begin{figure}[htbp]
\begin{center}
  \includegraphics[scale=.5]{R_package_development/SynthVolForecast/R/SVF_2016.png}
  \caption{The volatility induced by the 2016 US election results is predicted by the method}
  \label{fig:arith_mean}
  \end{center}
\end{figure}
Figure \ref{fig:arith_mean} shows a simple example.
