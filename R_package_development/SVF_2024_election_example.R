...
shock_dates_outside_loop <- list('2024 Election' = c("2024-11-05", list(1, c(1,1,0)))
                                ,'RFK_endorsement' = c("2024-08-23", list(1, c(1,1,0)))
                                ,'Trump_Biden_Debate' = c("2024-06-27", list(1, c(1,1,0)))
                                ,'2020 Election' = c("2020-11-03", list(1, c(1,1,0)))
                                ,'2016 Election' = c("2016-11-08", list(1, c(1,1,0)))
...
for (u in c(-1,0,2:number_of_covariates)){
  ...
  for (z in c(0,2:length(shock_dates_outside_loop))){
    ...
    #for (b in 1:50){ This loop is merely for testing how stochastic each prediction is
